...
-- Enrollments query
-- ============================================================================
select LAST_DAY(enroll_date) as endDate, 'indicator 1' as ind, date_format(enroll_date, '%M-%Y') as report_month,
...
count(distinct if(gender='F' and timestampdiff(year,birthdate, endDate) >=15,patient_id,null)) as 'HV03-33',
